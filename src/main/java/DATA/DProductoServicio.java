 ...
 * @author fpl
 */
public class DProductoServicio extends BaseDAO<DProductoServicio> {
    private int id;
    ...
    private static final String TABLE = "producto_servicios";
    private static final String QUERY_ID = "id";
    private static final String Q_NOMBRE = "nombre";
    private static final String QUERY_INSERT = String.format(
            "INSERT INTO %s (cantidad, created_at, producto_id, servicio_id) VALUES (?,?,?,?)", TABLE);
    ...
    @Override
    protected String[] entityToStringArray(DProductoServicio entity) {
        ...
        return new String[]{
                ...
                String.valueOf(entity.getProducto_id()),
                String.valueOf(entity.getServicio_id()),
                String.valueOf(entity.getCantidad()),
                createdAtStr,
                updatedAtStr
        };
    }
    @Override
    protected DProductoServicio stringArrayToEntity(String[] data) {
        DProductoServicio modelo = new DProductoServicio();
        try {
            modelo.setId(Integer.parseInt(data[0]));
            modelo.setProducto_id(Integer.parseInt(data[1]));
            modelo.setServicio_id(Integer.parseInt(data[2]));
            modelo.setCantidad(Double.parseDouble(data[3]));
    ...
    @Override
    protected void prepareStatementForEntity(DProductoServicio entity) throws SQLException {
        if (ps == null) {
            return;
        }
        // Para INSERT y UPDATE
        ps.setString(1, String.valueOf(entity.getCantidad()));
        ...
        if (ps.getParameterMetaData().getParameterCount() == 3) {
            ...
            ps.setString(3, String.valueOf(entity.getProducto_id()));
    ...
    public String[] ver() throws SQLException {
        DProductoServicio modelo = findById(this.id);
    ...
    public List<String[]> listar() throws SQLException {
        List<DProductoServicio> modelos = findAll();
        List<String[]> result = new ArrayList<>();
        for (DProductoServicio modelo : modelos) {
